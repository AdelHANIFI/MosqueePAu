...
class MainApp(QMainWindow):
    def __init__(self):
        ...
        # Ajouter les pages
        self.home_page = self.setup_ui()
        self.dons_page = DonsPage(self.pages)


        self.pages.addWidget(self.home_page)
        self.pages.addWidget(self.dons_page)

        self.pages.setCurrentWidget(self.home_page)  # Démarrer sur la page d'accueil
    ...
    def setup_ui(self):
        ...
        for button_data in buttons:
            ...
            buttons_layout.setContentsMargins(10, 0, 10, 0)  # Marges autour du layout des boutons
            # Icône
            icon_label = QLabel()
